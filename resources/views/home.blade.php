    ...
    <div class="container col-xxl-8 px-4 py-4">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-4">
            <div class="col-lg-6">
                ...
                <p class="lead">Jangan biarkan kesulitan akademis menghambat impian Anda. Temukan solusi dengan Nugas ICN
                        ...
                        <div class="col">
                            <div class="card shadow-sm border-success">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text" style="text-align: justify">Mengurangi beban dan stres bagi mahasiswa dengan menyelesaikan tugas-tugas individu mingguan.</p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-md btn-success"><i
                        ...
                        <div class="col">
                            <div class="card shadow-sm border-success">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text" style="text-align: justify">Menghemat waktu diskusi dan jadwal bagi mahasiswa dengan menyelesaikan tugas kelompok mereka.</p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-md btn-success"><i
                                                    class="fas fa-shopping-cart"></i> Pesan</button>
                        ...
                        <div class="col">
                            <div class="card shadow-sm border-success">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text" style="text-align: justify">Membantu mahasiswa dalam menyelesaikan tugas akhir mereka untuk mendapatkan nilai yang baik.</p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-md btn-success"><i
                                                    class="fas fa-shopping-cart"></i> Pesan</button>
                        ...
                        <div class="col">
                            <div class="card shadow-sm border-success">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text" style="text-align: justify">Membantu mahasiswa menghadapi ujian dan kuis tanpa kepanikan karena deadline.
                                    </p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-md btn-success"><i
